    ...
    function scan(options, callback) {
        ...
        function analyzeNpm(path, contents) {
            return function (cb) {
                ...
                function enqueue(deps) {
                    _(deps || {}).each(function (version, name) {
                        q.push(readFile(fspath.resolve(fspath.dirname(path), 'node_modules/' + name + '/package.json'), analyzeNpm));
                    });
                }
                enqueue(json.dependencies);
                enqueue(json.peerDependencies);
                enqueue(json.devDependencies);
                return cb();
            };
